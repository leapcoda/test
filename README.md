...
Sphere 是一个社区化的电商项目，该仓库（sphere-app）是其用户前台，使用 `Vue3`、`Vue-Router`、`Pinia`、`TDesign` 开发，旨在探索购物 + 互动场景下的最佳实践，持续更新中...
...
本项目是以**得物 App** 为原型的复刻项目，仅用于学习交流，不涉及商业用途。使用或分发本项目前，请阅读以下声明：
